...
- 出身、人物、地点、武学与物品描述优先采用“生活环境或眼前所见 → 做过或正在发生的具体事情 → 因此知道或能够做到什么”的顺序；
- 描述能力时使用具体经历、动作和物件，不用抽象标签替角色下结论；出身只交代经历与见识，人物的取舍由“初心”和后续选择决定；
- 玩家只能看到角色此刻理应知道的内容，不在出身或人物介绍中预告开场任务、隐藏身份、秘密势力与未来结果；
- 避免对仗口号、抽象概念堆叠、连续四字短语和刻意反转句；若一句话替换姓名后仍适用于任何角色，应改写为更具体的生活细节；
- 出身选择阶段使用“世家旁支”，在剧情正式揭示前不出现“沈家”；该界面不单列世界观、初始物品、眼前差事或暗处风声；
...
| `web/martial-system.mjs` | 四类武学目录、品阶、造诣、修为、阅历研习、条件突破、六个携带位、兵器条件、战斗映射与旧状态迁移 |
...
| `web/assets/martial/` | 武学页1920×1080暗纹背景、九宫格圆形武学徽记母版与旧矢量图标 |
...
| `tests/martial-system.test.mjs` | 武学目录、版本6至7迁移、研习突破、携带替换、兵器条件、人物派生与界面视图模型测试 |
...
- 姓名、出身、初心、命格；
- 命灯、潜能、山桃、篝火时间；
- `martial`统一记录阅历、已知传承、已学造诣与修为、节点见闻、领悟和六个携带位；顶层`potential`、`mindArt`、`skills`与`p0.activeMartial`只作兼容镜像；
- 五维分配和已完成固定奇遇；
- 龙青鱼奇遇阶段、选择日志、好感和关系；
- 心法、紫金河选择与结果；
- 下一程路线；
...
- 至少检查 1280×720、1272×660、390×844 与 844×390 横屏；
...
- 全屏人物页在1672×941与844×390下保持人物居中、九个等大装备槽、二十四格装备行囊、品质底框与可执行穿戴／替换／卸下；左侧人物／关系／百艺为连续竖排纸签，装备行囊格略高于宽且内部物品图不拉伸；品质文字、装备名和品质底边必须使用同一品质色；点击装备只打开详情浮层，必须在浮层内二次确认，若操作会移除已有装备则按钮显示“替换”；不显示命灯或潜能，显示境界、气血、真气、防御与减伤；
- 全屏武学页在1672×941下固定为31.4%所学列表、36%人物与六个等大携带位、32.6%武学详情；必须加载专用暗纹背景、圆形武学徽记和陈司命立绘，并在1280×720、844×390与390×844下保留分类、招式二级筛选、分类化详情、统一修为条、节点详情、阅历研习、条件突破与携带／替换／卸下，不得横向溢出；
- 行囊必须提供六类纯图标筛选、二十四格容量、右下角数量、品质底边、银两、无来处字段的物品详情与条件化使用；844×390下不继承场景信箱留黑；
- 武学页在1272×660中等横屏下六个携带位必须保留清楚的三排间隔；尚无传承时不得回退到大号单字或硬边空框；
- 武学携带位内的圆形徽记统一占槽宽72%，并补偿图集透明留边，禁止空位图标额外缩小；
...
- 拜师、两门桩功、阅历消耗和锻体突破；
- 武学四类、五档品阶与造诣、六个携带位、兵器缺口、研习、突破、节点、手动卸下保持、战斗只读取携带武学，以及版本6到版本7迁移；
