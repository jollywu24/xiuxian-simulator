import { rollCausalDie } from "./wudao-p0-core.mjs?v=20260807.1";
import { P1_ARCS, P1_CONTENT_NODES, getP1Arc, getP1Node } from "./content/p1/arcs.mjs?v=20260807.1";
import { M4_EVIDENCE, M4_LOCATIONS, M4_METHOD } from "./content/p1/catalogs.mjs?v=20260807.1";
