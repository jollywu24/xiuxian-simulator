export const ORIGINS = [
  {
    ...
    name: "世家旁支",
    tag: "世家旁支",
    cardImage: "./assets/origins/cards/clan-branch-v1.webp",
    summary: "你生在高墙里面，却从没被写进嫡脉的次序。衣食有人管，前程要自己抢。",
  ...
  },
  {
    ...
    name: "市井子弟",
    tag: "市井",
    cardImage: "./assets/origins/cards/streetborn-v1.webp",
    summary: "没人替你留门。你认得码头每条近路，也知道一句话该卖给谁、卖多少。",
  ...
  },
  {
    ...
    name: "身世成谜",
    tag: "残忆",
    cardImage: "./assets/origins/cards/mystery-v1.webp",
    summary: "你不记得自己从哪里来。半块玉佩和一封血书，替过去留下了两道互相矛盾的证词。",
