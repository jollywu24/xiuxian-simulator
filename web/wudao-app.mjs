import {
  ...
  templeTaskCost,
} from "./wudao-core.mjs?v=20260807.1";
import { getRoutePresentation, getScenePresentation } from "./wudao-scenes.mjs?v=20260807.1";
import {
  P0_STAKES,
  createDeathRecord,
  createP0State,
  ...
  chooseStake,
} from "./wudao-p0-core.mjs?v=20260807.1";
import {
  M4_EVIDENCE,
  M4_METHOD,
...
} from "./wudao-p1-core.mjs?v=20260807.1";
import {
...
} from "./combat-lab-core.mjs?v=20260807.1";
import {
  INVENTORY_CAPACITY,
...
} from "./inventory-core.mjs?v=20260807.1";
import {
  EQUIPMENT_CAPACITY,
  EQUIPMENT_SLOTS,
...
} from "./character-system.mjs?v=20260807.1";
import {
  MARTIAL_MASTERIES,
  breakthroughMartial,
...
} from "./martial-system.mjs?v=20260807.1";
import { SAVE_STORAGE_KEY } from "./save-core.mjs?v=20260807.1";
import { createSaveStorage } from "./save-storage.mjs?v=20260807.1";
import {
  ORIGINS,
...
} from "./origin-core.mjs?v=20260807.1";
import {
  APPEARANCE_BODIES,
  APPEARANCE_CATALOGS,
  APPEARANCE_PARTS,
...
import { renderPaperDollCanvases } from "./paperdoll-renderer.mjs?v=20260807.1";

const PAPER_DOLL_ASSET_VERSION = "20260807.1";
