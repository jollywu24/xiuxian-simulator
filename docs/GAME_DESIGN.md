...
后续战斗统一使用“敌招 → 战局 → 选择 → 预测 → 兑现 → 余波”。敌招先公开主要目标和已知后手；战局显示双方气血、境界、距离、伤势、环境和见闻；按钮在行动前说明胜算、主要依据、预计气血／位置变化与风险；结算用短段落表现出手、位移、代价和敌人下一步；重要战斗最终必须把伤势、关系、活口、证据、势力警戒或路线变化带回剧情。玩家最大气血为十二加根骨两倍及境界加成，既有伤势降低入场气血；自身归零进入命灯死局，击杀令敌方归零，制伏保留一点。气血用于公开换伤压力，不取代战斗目的。疲劳、士气与架势只在特定战斗中转化为“失衡”“喘息”“胆怯”“受困”等临时标签，不新增更多全局数值条。
