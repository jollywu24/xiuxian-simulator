...
后续战斗统一使用“敌招 → 战局 → 选择 → 预测 → 兑现 → 余波”。敌招先公开主要目标和已知后手；战局只显示会改变当前选择的境界、距离、伤势、环境和见闻；按钮在行动前说明胜算、主要依据、预计兑现与风险；结算用短段落表现出手、位移、代价和敌人下一步；重要战斗最终必须把伤势、关系、活口、证据、势力警戒或路线变化带回剧情。疲劳、士气与架势只在特定战斗中转化为“失衡”“喘息”“胆怯”“受困”等临时标签，不新增全局数值条。
