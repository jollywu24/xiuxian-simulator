...
>
> 相关文档：[SYS-11 三出身与独立序章](systems/11_ORIGIN_PROLOGUES.md)、[SYS-09 装备系统与统一战斗公式](systems/09_EQUIPMENT_COMBAT_FORMULA.md)、[D-013 容貌与装备外观决策](DECISION_LOG.md#d-013容貌采用十一类离散部件装备不再改变角色外观)。
...
如果创建页衣服与后续装备共同改变人物外观，两套来源就会互相覆盖；如果衣服带数值，玩家又会在捏脸阶段提前做装备选择。本项目因此明确分工：衣服只决定外观，装备只决定数值、动作与叙事权限。
...
| 原作做法 | 《武道》改法 |
| --- | --- |
| 十一类部件 | 保持帽子、前发、后发、眼睛、眉毛、嘴巴、鼻子、脸型、后背、衣服、脸饰十一类不变 |
| 部分五官滑杆 | 不做滑杆；每张面容由美术直接确认 |
| 衣服属于捏脸部件 | 保持为纯外观部件；装备不改变人物外观 |
...
- 换帽子、衣服或脸饰不会改变任何装备槽；
- 更换兵器、衣甲或佩饰不会改变人物外观；
- 装备仍可正常提供数值、动作、身份与叙事权限；
- 新外观只进入容貌目录，新装备只进入装备目录，两者不建立外观映射。
...
| --- | ---: | --- |
| 体貌 | 2 | 共用同一姿势与人物标尺 |
| 帽子／前发／后发 | 每类6～8 | 优先形成清楚轮廓，不做过长辫发 |
| 眼睛／眉毛／嘴巴／鼻子／脸型 | 每类4～8 | 使用共同人物标尺，组合后不漂移 |
| 衣服 | 6～8 | 纯外观，不附带装备属性 |
| 后背／脸饰 | 每类4～6且包含“无” | 只保留远看仍有辨识度的选项 |
...
- 未选出身前不显示主角形象；
- 姓名输入经过转义并遵守长度限制；
- 男身／女身与十一类外观部件都能即时更新预览；
- 页面正好包含帽子、前发、后发、眼睛、眉毛、嘴巴、鼻子、脸型、后背、衣服、脸饰，不增加范围滑杆；
- 随机不会改变出身、姓名或后续玩法状态；
...
- 创建页和人物页显示同一套外观；
- 装备详情打开、装备、替换与卸下都不改变人物外观；
- 更换外观不改变装备槽、战斗数值或叙事权限；
- 外观部件与装备目录分别进入发布契约和浏览器回归。
...
> **保留十一类离散外观部件，人物居中即时预览；衣服决定形象，装备决定玩法。**
...
首版的目标不是让玩家复刻任何一张现实面孔，而是让玩家在一两分钟内通过十一类清楚的部件得到一个“这是我的江湖人物”的明确感觉，并让这个形象不因战斗装备更新而被迫改变。
