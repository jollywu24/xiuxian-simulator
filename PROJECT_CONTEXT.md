...
| 十一类容貌、旧档迁移与人物分层合成 | `web/appearance-core.mjs`、`web/paperdoll-system.mjs` | `tests/appearance-system.test.mjs`、`tests/paperdoll-system.test.mjs`、`docs/systems/11_ORIGIN_PROLOGUES.md` |
