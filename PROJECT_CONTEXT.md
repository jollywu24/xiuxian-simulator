...
| 雨夜破庙三地区、十二对象、局面时间与自动推进 | `web/temple-exploration.mjs`、`web/wudao-scenes.mjs`、`web/wudao-app.mjs` | `tests/temple-exploration.test.mjs`、`scripts/cdp-smoke.mjs`、`scripts/cdp-origins.mjs`、`docs/systems/14_RUINED_TEMPLE_VERTICAL_SLICE.md` |
