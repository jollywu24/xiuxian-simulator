...
| 十一类容貌、旧档迁移、槽位／遮罩规则与Canvas合成 | `web/appearance-core.mjs`、`web/paperdoll-system.mjs`、`web/paperdoll-renderer.mjs` | `tests/appearance-system.test.mjs`、`tests/paperdoll-system.test.mjs`、`docs/systems/12_APPEARANCE_RIG.md` |
